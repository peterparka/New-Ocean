<footer>
	...
	<section class="grid-center">
		...
		<?php wp_nav_menu(array(
	        ...
	        'container' => false,
	        'items_wrap' => '<ul id="%1$s" class="grid-center col-12">%3$s</ul>',
	        'fallback_cb' => false
	    )); ?>
	</section>
</footer>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAsU-ft0miSYlXFl1okB1GCXOehpeRkT9Y"></script>
