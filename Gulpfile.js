...
var $           = require('gulp-load-plugins')(),
    ...
    basePaths = {
        src: 'assets/',
        dest: 'public/wp-content/themes/new-ocean/'
    },
...
gulp.task('vendorScripts', function() {
    var bowerPackages = [
        ...
        basePaths.src + 'bower-packages/foundation/js/foundation.min.js'
    ];
...
gulp.task('default', ['clean'], function(cb) {
  if ( ! production )
    runSequence( 'bower', 'styles', 'vendorScripts', 'scripts', 'modernizr', 'images', ['svgstore'], 'svginject', 'svgfallback', cb);
  else
    runSequence( 'bower', 'styles', 'vendorScripts', 'scripts', 'modernizr', 'images', ['svgstore'], 'svginject', cb);
});
